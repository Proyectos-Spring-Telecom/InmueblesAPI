...
@Index("FK_Historico_Arrendatario_idx", ["idArrendatario"], {})
@Index("FK_Historico_Contrato_idx", ["idContrato"], {})
@Entity("HistoricoPagosRenta")
@applySchema
export class HistoricoPagosRenta {
