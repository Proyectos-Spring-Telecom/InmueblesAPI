...
@Index("FK_HistMant_Arrendatario_idx", ["idArrendatario"], {})
@Index("FK_HistMant_Contrato_idx", ["idContrato"], {})
@Entity("HistoricoPagosMantenimiento")
@applySchema
export class HistoricoPagosMantenimiento {
