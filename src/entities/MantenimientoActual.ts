...
@Index("FK_Mantenimiento_Arrendatario_idx", ["idArrendatario"], {})
@Index("FK_Mantenimiento_Contrato_idx", ["idContrato"], {})
@Entity("MantenimientoActual")
@applySchema
export class MantenimientoActual {
